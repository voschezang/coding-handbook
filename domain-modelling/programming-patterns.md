...
Design patterns for applications and systems. See also [organization structure](../systems/structure.md) and [communication patterns](../systems/communication-patterns.md).
